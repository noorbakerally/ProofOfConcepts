...
unused = ["foaf:depiction","//dc:description","//po:Clip","//foaf:Document","//foaf:Image","//foaf:thumbnail","//wo:collection","//wo:Collection","//owl:AnnotationAssertion","//owl:AnnotationProperty"]
